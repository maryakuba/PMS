...
public class PurchaseHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medicine ID", "Bill ID", "Name", "Customer", "Date & Time", "Total Paid"
            }
        ));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            while(rs.next()){
                model.addRow(new Object[] {rs.getString("uniqueId"),rs.getString("billId"),rs.getString("name"),rs.getString("customerName"),rs.getString("billDate"),rs.getString("totalPaid")});
            }
        }
        catch(Exception e){
